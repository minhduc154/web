...
<h1 align="center">Danh Sách Loại Hàng</h1>

<button class="btn btn-info "><a href="<?=base_url();?>/index.php/qlbh_controller/viewthemLoaihang"><H4>Thêm Loại Hàng</H4></a></button>
<div class="table-responsive">
	<table class="table table-hover">
		...
		<tbody>
			<?php
			foreach ($loaihang as $value):	
		?>	
			<tr>
				<td><?= $value['id_loaihang'] ?></td>
				<td><?= $value['tenloaihang'] ?></td>
				
				<td><button class="btn-info"><a href="<?=base_url();?>index.php/qlbh_controller/xoaLoaihang/<?= $value['id_loaihang']?>">Xóa</a></button></td>
			</tr>
			<?php
		endforeach;
			?>
