...
<div class="container">
		<div class="account">
	<form action="<?=base_url();?>index.php/qlbh_controller/themLoaihang" method="POST" role="form" enctype="multipart/form-data">
		<legend>Thêm Loại Hàng</legend>
	
		<div class="form-group">
			<label for="">Id Loại Hàng</label>
			<input type="text" name="id_loaihang" class="form-control" id="" placeholder="Nhập vào id loại hàng">
		</div>
		<div class="form-group">
			<label for="">Tên Loại Hàng</label>
			<input type="text" name="tenloaihang" class="form-control" id="" placeholder="Nhập vào tên loại hàng">
		</div>
		

		<button type="submit" class="btn btn-danger">Thêm Loại Hàng</button>
		<a href="<?=base_url();?>index.php/qlbh_controller/viewLoaihang" class="btn btn-danger">Hủy Thêm</a>
	</form>
</div>
	</div>
