...
<div class="container">
		<div class="account">
	<form action="<?=base_url();?>index.php/qlbh_controller/themNhanvien" method="POST" role="form" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<input type="text" name="gioitinh" class="form-control" id="" >
		</div>
		<div class="form-group">
		...
		<a href="<?=base_url();?>index.php/qlbh_controller/nhanvien" class="btn btn-danger">Hủy Thêm</a>
	</form>
</div>
	</div>
