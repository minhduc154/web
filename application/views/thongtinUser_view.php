...
<?php foreach ($nv as $value): ?>
	<div class="container">
		<div class="account">
	<form action="<?=base_url();?>index.php/qlbh_controller/suaNhanvien2/<?=$value['id_nhanvien']?>" method="POST" role="form" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<input type="text" name="gioitinh" class="form-control" id="" value="<?=$value['gioitinh']?>" >
		</div>
		<div class="form-group">
			<label for="">Ngày Sinh</label>
			<input type="date" name="ngaysinh" class="form-control" id="" value="<?=$value['ngaysinh']?>">
		</div>
		<div class="form-group">
			<label for="">Avatar</label>
			<input type="file" name="avatar" class="form-control" id="" >
			<img src="<?=base_url().$value['avatar']?>" width="200" height = "200">
		...
		<button type="submit" class="btn btn-danger" name="btnsuanv">Cập Nhật Thông Tin</button>
	</form>
