...
<div class="container">
		<div class="account">
	<form action="<?=base_url();?>index.php/qlbh_controller/themMathang" method="POST" role="form" enctype="multipart/form-data">
		<legend>Thêm Mặt Hàng Mới</legend>
	
		<div class="form-group">
			<label for="">Loại Hàng:</label>
			<select name="id_loaihang" id="" class="form-control" >
					<option >Chọn Loại Hàng</option>
					<?php foreach ($loaihang as $value) {
						
					?>
					<option value = "<?=$value['id_loaihang']?>"><?=$value['tenloaihang']?></option>
					<?php
						}
					?>
			</select>
		...
		<div class="form-group">
			...
			<select name="id_congty" id="" class="form-control" >
					<option >Chọn Nhà Cung Cấp</option>
					<?php foreach ($nhacc as $value) {
						
					?>
					<option value = "<?=$value['id_congty']?>"><?=$value['tencongty']?></option>
					<?php
						}
					?>
			</select>
		...
		<div class="form-group">
			...
			<input type="text" name="tenhang" class="form-control" id="" >
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			<label for="">Giá Hàng</label>
			<input type="text" name="giahang" class="form-control" id="">
		</div>
		<button type="submit" class="btn btn-danger">Thêm Hàng</button>
		<a href="<?=base_url();?>index.php/qlbh_controller/mathang" class="btn btn-danger">Hủy Thêm</a>
	</form>
	<br>
</div>
	</div>
