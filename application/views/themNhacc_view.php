...
<div class="container">
		<div class="account">
	<form action="<?=base_url();?>index.php/qlbh_controller/themNhacc" method="POST" role="form" enctype="multipart/form-data">
		<legend>Thêm Nhà cung cấp</legend>
	
	
		<div class="form-group">
			<label for="">Tên công ty</label>
			<input type="text" name="tencongty" class="form-control" id="">
		</div>
		<div class="form-group">
		...
		<button type="submit" class="btn btn-danger">Thêm  nhà cung cấp</button>
		<a href="<?=base_url();?>index.php/qlbh_controller/nhacc2" class="btn btn-danger">Hủy Thêm</a>
	</form>
</div>
	</div>
