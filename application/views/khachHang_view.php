		...
		<div class="container">
			<div class="h_menu4">
				<a class="toggleMenu" href="#">Menu</a>
					...
					<li class="active"><a href="<?=base_url(); ?>index.php/qlbh_controller/khachhang">Quản Lý Khách Hàng</a></li>		 
					...
					if (isset($_SESSION['username']))
					 ...
					 ?>
					 <li ><a href="<?=base_url(); ?>index.php/qlbh_controller/nhanvien" >Quản Lý Nhân Viên</a>
...
<h1 align="center">Danh Sách khach hang</h1>
	<form action="<?=base_url();?>/index.php/qlbh_controller/timkiemKhachhang" method="POST" role="form">
