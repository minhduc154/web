...
<body>
	<div class="header">
		...
		<div class="header-bottom-on">
			<p class="wel"><a href="#">Chào mừng đến với <b> Web quản lý </b></a></p>
			<div class="clearfix"></div>
		</div>
		</div>
		</div>
	...
	<div class="container">
		...
		<form action="" method="POST" role="form-data">
			...
			<br>
				...
				<button type="submit" class="btn btn-success"><a href="<?=base_url(); ?>index.php/qlbh_controller/index2">Trang Web Mua Hàng</a></button>
	</div>
		<!---->
